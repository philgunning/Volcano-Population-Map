...
html = """<br>Volcano Name: <a href="https://www.google.com/search?q=%%22%s%%22" target="_blank">%s</a></br>
    <br>Height: %s m</br>
    """
...
for lt, ln, el, name in zip(lat, lon, elev, name):
    iframe = folium.IFrame(html=html % (name, name, int(el)), width=200, height=100)
